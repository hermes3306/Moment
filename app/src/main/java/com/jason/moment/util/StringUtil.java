...
public class StringUtil {
    ...
    public static String elapsedStr(Date start_date, Date end_date) {
        long endTime, startTime;
        startTime = start_date.getTime();
        endTime = end_date.getTime();
        long duration = endTime - startTime;
        return elapsedStr(duration);
    }

    public static String elapsedStr(long duration) {
    ...
    public static String elapsedStr2(Date start_date, Date end_date) {
        long endTime, startTime;
        startTime = start_date.getTime();
        endTime = end_date.getTime();
        long duration = endTime - startTime;
    ...
    public static String elapsedStr2(long duration) {
        long dur_sec = duration / 1000;
        long duration_r;
        int dur_hour_Int = (int)(dur_sec/3600);
        duration_r = dur_sec - (long)(dur_hour_Int) * 60 * 60;
        ...
        int dur_sec_Int = (int)(duration_r);
        String dur_str="";
        if(dur_hour_Int < 10) dur_str += "";
        if(dur_hour_Int!=0) dur_str = dur_str + dur_hour_Int + ":";
        if(dur_min_Int < 10 && dur_min_Int!=0) dur_str += "0";
        if(dur_min_Int!=0) dur_str = dur_str + dur_min_Int + ":";
        if(dur_sec_Int < 10) dur_str += "0";
        dur_str = dur_str + dur_sec_Int;
        return(dur_str);
    }
