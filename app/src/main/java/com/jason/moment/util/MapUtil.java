...
//                            .snippet(""+interval + unitstr));
    ...
    public void DRAW(Context _ctx, GoogleMap googleMap, ArrayList<Marker> _markers, Display display, MyActivity lastActivity, ArrayList<MyActivity>mActivityList) {
