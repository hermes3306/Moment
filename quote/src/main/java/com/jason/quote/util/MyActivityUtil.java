...
public class MyActivityUtil {
    ...
    public static ArrayList<String> deserializeMediaInfoFromCSV(String file_name) {
        ...
        File file = new File(Config.CSV_SAVE_DIR, file_name);
    ...
    public static void serializeIntoCSV(ArrayList<MyActivity> list, ArrayList<String> media_list, File f) {
        try {
            ...
            for(int i=0;i<list.size();i++ ) {
                ...
                String crd = StringUtil.DateToString(d, "yyyy/MM/dd");
                String crt = StringUtil.DateToString(d, "HH:mm:ss");
    ...
    public static void serializeIntoCSV(ArrayList<MyActivity> list, ArrayList<String> media_list, String fileName) {
        ...
        File f = new File(Config.CSV_SAVE_DIR, fileName);
    ...
    public static void serializeIntoJason(ArrayList<MyActivity> list, int start, int end, String fileName) {
        ...
        File file = new File(Config.MNT_SAVE_DIR, fileName);
