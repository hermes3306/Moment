...
public class Record {
    ...
    public static final String MSG_RECORD_CHANGED="com.jason.moment.record.CHANGED";
    ...
    static public ArrayList<Date> getRecords(Context context) {
        File file[] = Config.JSN_SAVE_DIR.listFiles();
    ...
    public void  save() {
        String filename = String.format(Config.JSN_SAVE_DIR + "/record-%d.json", System.currentTimeMillis());
        try {
    ...
    public void read(Date date) {
        String filename = String.format(Config.JSN_SAVE_DIR+"/record-%d.json", date.getTime());
        try {
